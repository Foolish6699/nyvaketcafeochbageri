...
import photo8 from "@/assets/photo-macka-kaffe.jpg";
import photo9 from "@/assets/photo-bakelse.jpg";
...
const photos = [
  ...
  { src: photo8, alt: "Macka och kaffe på träbord" },
  { src: photo9, alt: "Bakelse och kaffe i bärnstensglas" },
